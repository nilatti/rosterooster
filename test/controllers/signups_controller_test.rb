...
class SignupsControllerTest < ActionController::TestCase
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post :create, signup: { gathering_id: @signup.gathering_id, person_id: @signup.person_id, registration_id: @signup.registration_id }
    end
  ...
  test "should update signup" do
    patch :update, id: @signup, signup: { gathering_id: @signup.gathering_id, person_id: @signup.person_id, registration_id: @signup.registration_id }
    assert_redirected_to signup_path(assigns(:signup))
  end
