...
class PromisesControllerTest < ActionController::TestCase
  ...
  test "should create promise" do
    assert_difference('Promise.count') do
      post :create, promise: { item_id: @promise.item_id, person_id: @promise.person_id, registration_id: @promise.registration_id }
    end
  ...
  test "should update promise" do
    patch :update, id: @promise, promise: { item_id: @promise.item_id, person_id: @promise.person_id, registration_id: @promise.registration_id }
    assert_redirected_to promise_path(assigns(:promise))
  end
